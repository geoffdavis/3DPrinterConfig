...
* FYSETC Spider 2.2 mainboard (USB-CAN bridge mode)
* Mellow SB2040 CAN bus toolhead
* Slice Mosquito Magnum hotend (Revo V6 alternate)
* Bondtech CHT nozzles
* Happy Hare MMU2S multi-material unit
* Fluidd / Mainsail web UI
...
![Bottom Electronics Bay with finger ducting](images/electronics_bay_duct.jpeg)
...
![FYSETC Spider 2.2 Mainboard Rear](images/spider2.2-board-rear.jpeg)
...
Following the procedures detailed in the Voron [V2 Gantry Squaring](https://docs.vorondesign.com/build/mechanical/v2_gantry_squaring.html) documentation, I worked through reassembling the frame.
